...
const HelmetHead = () => (
  <Helmet>
    ...
    <meta
      name="twitter:image"
      content="http://blog.davidhartsough.com/icon-512x512.png"
    />
    <meta name="twitter:image:alt" content="David Hartsough's logo" />
    <meta property="og:site_name" content="David Hartsough's Writings" />
    <meta
      property="og:image"
      itemprop="image"
    ...
    />
    <meta name="application-name" content="David Hartsough's Writings" />
...
export default ({ location, children }) => (
  <div>
    ...
    <nav>
      <h1>
        <a href="http://davidhartsough.com">
          David<span id="last-name"> Hartsough</span>
        </a>
        <span>
          {' '}
          &mdash;{' '}
